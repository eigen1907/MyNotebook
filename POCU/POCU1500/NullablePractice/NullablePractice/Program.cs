...
namespace NullablePractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"foo1 is {foo1.Number}");
            }
            ...
            {
                Console.WriteLine($"foo2 is {foo2.Number}");
            }
            ...
            {
                Console.WriteLine($"bar2 is {bar2.Value.Number}");
            }
            ...
            {
                Console.WriteLine($"bar3 is {bar3.Value.Number}");
            }
        }
